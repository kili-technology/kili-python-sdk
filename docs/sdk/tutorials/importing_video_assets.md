...
Except the processingParameters, json metadatas aren't persistent, this means that if you want to update one metadata you will have to pass all the others metadatas to keep them, otherwise it will be erased.
