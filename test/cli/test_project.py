        ...
        return [{'activated': True,
                ...
                'id': 'role_id_2',
                 ...
                 'user': {'email': 'jane.doe@test.com',
                          ...
                          'lastname': 'doe',
                          'organization': {'name': 'test'}}}, ]
    elif project_id == 'project_id_dest':
        return [{'activated': True,
                'id': 'role_id_3',
                 'role': 'LABELER',
                 'user': {'email': 'john.doe@test.com',
...
class TestCLIProject():
    ...
    def test_list_members(self, mocker):
        ...
        result = runner.invoke(
            list_members, ['--project-id', "project_id_dest"])
        debug_subprocess_pytest(result)
    ...
    def test_add_member(self, mocker):
        TEST_CASES = [{
            ...
            'inputs': ['jane.doe@test.com', 'john.doe@test.com'],
            'options': {
    ...
    def test_update_member(self, mocker):
        TEST_CASES = [{
            'case_name': "AAU, when I update user's role with email adresses, I see a success",
            'inputs': ['jane.doe@test.com', 'john.doe@test.com'],
            'options': {
                'project-id': 'project_id_dest',
                'role': 'TEAM_MANAGER'
        ...
        with runner.isolated_filesystem():
            ...
            with open('user_list.csv', 'w') as f:
                writer = csv.writer(f)
                writer.writerow(['alice@test.com', 'REVIEWER'])
                writer.writerow(['bob@test.com', 'ADMIN'])
