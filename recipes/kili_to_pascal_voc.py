        ...
        "annotations": [
            {
                "boundingPoly": [
                    {
                        "normalizedVertices": [
                            {"x": 0.5559003685448103, "y": 0.4574172704456453},
                            {"x": 0.5559003685448103, "y": 0.16874512185265989},
                            {"x": 0.8007011034682624, "y": 0.16874512185265989},
            ...
            },
            {
                "boundingPoly": [
                    {
                        "normalizedVertices": [
                            {"x": 0.32129966424316886, "y": 0.6690094212467863},
                            {"x": 0.32129966424316886, "y": 0.34859845003362977},
                            {"x": 0.6205005624829435, "y": 0.34859845003362977},
            ...
            },
            {
                "boundingPoly": [
                    {
                        "normalizedVertices": [
                            {"x": 0.17084921257146393, "y": 0.16421100433549252},
                            {"x": 0.17084921257146393, "y": 0.11433571164665213},
                            {"x": 0.3297996897613443, "y": 0.11433571164665213},
...
def main():
    parameters = {"filename": "file_001.png"}
    output_file = "./examples/voc_label.xml"
    width = 1920
    height = 1080
    transform_kili_response_to_pascal_voc(response, output_file, width, height, parameters)
