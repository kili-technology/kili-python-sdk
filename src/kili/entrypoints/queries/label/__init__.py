...
class QueriesLabel:
    ...
    def export_labels(
        ...
        Args:
            ...
            normalized_coordinates: If True, the coordinates of the `(x, y)` vertices are normalized between 0 and 1. If False, the coordinates are in pixels.
                This parameter is only effective on the Kili (a.k.a raw) format. Beware that once the coordinates in the json response are unnormalized, they cannot be imported back to Kili as-is, since Kili expects normalized coordinates.
