...
class QueriesLabel:
    ...
    def export_labels(
        ...
        Args:
            ...
            normalized_coordinates: If True, the coordinates of the bounding boxes are normalized between 0 and 1. If False, the coordinates are in pixels.
                Only available for PDF projects for now.
