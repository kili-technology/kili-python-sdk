...
def test_format_result_no_type_conversion_1():
    result = r'{"data":{"data":{"id":"claqu1f012345678905oi4evp","email":"username@kili-technology.com"}}}'
    result = json.loads(result)
...
def test_format_result_no_type_conversion_2():
    result = r'{"data":{"data":[{"createdAt":"2022-12-12T13:52:14.989Z"},{"createdAt":"2022-12-09T08:33:55.940Z"},{"createdAt":"2022-11-29T16:48:09.456Z"},{"createdAt":"2022-11-29T16:44:29.652Z"},{"createdAt":"2022-11-29T16:44:06.341Z"},{"createdAt":"2022-11-29T16:40:07.941Z"},{"createdAt":"2022-11-25T08:14:12.298Z"}]}}'
    result = json.loads(result)
    ret = format_result("data", result)
    assert len(ret) == 7
...
def test_format_result_legacy_orm_objects():
    result = r'{"data":{"data":[{"id": "clbp1ozzb12345678cl9l85ci"}]}}'
    result = json.loads(result)
