...
def get_project_statistics(project: dict) -> Tuple[List[list], List[list], List[list]]:
    """Get statisctics for a project.

    Args:
        project: a project with its statistics fields

    Return:
        info, dataset_kpis, quality_kpis: arrays that contain
        the project infos and progress statistics
    """
    progress = round(
    ...
    dataset_statistics = [['Total number of assets', project['numberOfAssets']],
                          ['Number of remaining assets',
                           project['numberOfRemainingAssets']],
                          ['Skipped assets', project['numberOfAssetsWithSkippedLabels']],
                          ['Progress', str(progress)+'%']]
    quality_statistics = [['Project consensus', project['consensusMark'] or 'N/A'],
    ...
    return infos, dataset_statistics, quality_statistics
